...
from complex_log import ComplexLogEnv
...
if __name__ == "__main__":
    ...
    parallel_env = ParalllelWrapper([ComplexLogEnv(seed=args.seed) for _ in range(args.n_env)], args.n_env)
    eval_env = ComplexLogEnv(seed=args.seed+100)
    # env.seed(args.seed)
